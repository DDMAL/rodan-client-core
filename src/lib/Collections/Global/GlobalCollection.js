...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    _initializeRadio()
    {
        Radio.channel('rodan-client-core').reply(this._loadCommand, options => this._retrieveCollection(options));
        Radio.channel('rodan-client-core').reply(this._requestCommand, () => this._handleRequestInstance());
    }
    ...
    _retrieveCollection(options)
    {
        ...
        options.data = data;
        /** @ignore */
        this.url = Radio.channel('rodan-client-core').request(RODAN_EVENTS.REQUEST__SERVER_GET_ROUTE, this._route);
        this.fetch(options);
    }
}